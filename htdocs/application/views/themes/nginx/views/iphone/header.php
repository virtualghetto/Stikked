...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo site_url() . '/'; ?>themes/default/css/iphone.css" type="text/css" media="screen" title="iphone stylesheet" charset="utf-8" />
	</head>
	<body>
		<div id="container">
			<div class="header">
				<div class="container">
					...
					<div class="toolbar">	
						<ul>
							...
							<li class="<?php if($page =="" || $page == "view"){?>active<?php } ?>"><a href="<?php echo site_url() . '/'; ?>iphone">View</a></li>
						</ul>
					</div>
				</div>
			</div>
